...
public class UpdateCollectibleLevel2 : MonoBehaviour
{
    [Header("UI")]
    ...
    private void UpdateCollectibleDisplay()
    {
        ...
        if (collectibleText != null)
            collectibleText.text = $"TÜM MEYVELERİ BUL: {totalCollectibles}";
    ...
    private IEnumerator WinTransition()
    {
        ...
        if (birthdayText != null)
            birthdayText.text = "Tebrikler Tüm Meyveleri Topladın!";
