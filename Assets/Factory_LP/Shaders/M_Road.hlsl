...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.200000,0.000000,0.000000,0.000000);//(Unknown)

	Material.PreshaderBuffer[0].x = SelectionColor.w;
	Material.PreshaderBuffer[0].yzw = SelectionColor.xyz;
	Material.PreshaderBuffer[1].x = Color_Contrast;
}
float3 GetMaterialWorldPositionOffset(FMaterialVertexParameters Parameters)
{
SHADER_PUSH_WARNINGS_STATE
SHADER_DISABLE_WARNINGS
	return MaterialFloat3(0.00000000f,0.00000000f,0.00000000f);;
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local0 = lerp(MaterialFloat3(0.00000000f,0.00000000f,0.00000000f),Material.PreshaderBuffer[0].yzw,Material.PreshaderBuffer[0].x);
	...
	MaterialFloat3 Local5 = normalize(Local3.rgb);
	MaterialFloat Local6 = dot(Local3.rgb,MaterialFloat3(0.21263900f,0.71516865f,0.07219232f));
	MaterialFloat Local7 = PositiveClampedPow(Local6,Material.PreshaderBuffer[1].x);
	MaterialFloat3 Local8 = (Local5 * ((MaterialFloat3)Local7));
...
void SurfaceReplacement( Input In, out SurfaceOutputStandard o )
{
	...
	o.Smoothness = 1.0 - clamp(PixelMaterialInputs.Roughness, 0, 1);
